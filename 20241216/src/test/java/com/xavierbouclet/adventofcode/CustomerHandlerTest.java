...
class CustomerHandlerTest {
    ...
    @Test
    void getAll() throws ServletException, IOException {
        ...
        ServerResponse response = customerHandler.getAll();
    ...
    void getCustomer() throws ServletException, IOException {
        ...
        ServerResponse response = customerHandler.getById(serverRequest);

        String body = ServerResponseExtractor.extractBody(response);

        new JsonContentAssert(this.getClass(), body).isEqualToJson("""
                 {"id":"%s","firstName":"Santa","lastName":"Claus"}
                """.formatted(id));
    }
    ...
    void deleteById() {
        ...
        ServerResponse response = customerHandler.deleteById(serverRequest);
